...
export interface TraceDetail { run: TraceRun; events: TraceEvent[]; nextAfter: number | null; related: { id: string; agentId: string; channel?: string; status: string }[]; warning?: string; }
