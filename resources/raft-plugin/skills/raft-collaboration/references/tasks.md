...
raftctl task claim --id TASK --expected-version VERSION --request-id UNIQUE_ID --json
raftctl task submit --id TASK --expected-version VERSION --evidence '修改文件、验证命令及实际结果' --request-id UNIQUE_ID --json
```
